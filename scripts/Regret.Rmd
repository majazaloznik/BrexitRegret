...
According to the survey, the proportion regretting their vote was significantly higher among leave voters (5.78 %) compared to remain voters (1.43 %).
...
kable(regrets.prop*100, digits = 2, caption = "Table 1: Percentage regreting their vote in each EU referendum camp")
```
